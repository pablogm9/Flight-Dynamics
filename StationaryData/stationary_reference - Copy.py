...
moment_payload_0 = x_cg_payload_0*np.array(passenger_masses)*2.20462*386.09
moment_payload_1 = x_cg_payload_1*np.array(passenger_masses)*2.20462*386.09
...
moment_total_aircraft = np.array([moment_BEM,moment_BEM])+np.array([moment_fuel_load_mean,moment_fuel_load_mean])+moment_total_payload
